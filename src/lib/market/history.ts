...
// Provider-agnostisk historikk: sampler jevnt fordelte punkter i
// [from, to] via getLatestObservation. Fungerer med enhver
// MarketDataProvider-implementasjon uten at grensesnittet trenger en egen
// "historikk"-metode.
